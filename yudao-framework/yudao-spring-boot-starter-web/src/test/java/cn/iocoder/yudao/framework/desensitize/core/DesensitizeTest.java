...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("源码");
        ...
        desensitizeDemo.setRegex("你好，我是源码");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("源码");
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "源码", replacer = "*")
